drop table if exists payme_sandbox.p2p_user_activation_transactions;
create table payme_sandbox.p2p_user_activation_transactions as
with users as (
...
from
(
select r.payer_id, min(r.create_time) create_time,
case
...
from ods__mdbrt__identification.operator_tickets
