drop table if exists payme_sandbox.p2p_user_activation_sessions_30;

create table payme_sandbox.p2p_user_activation_sessions_30 as
with users as (
...
, user_sessions as (
    ...
    join users u
        on j.user_id = u._id
    and j.date < u.reg_date + interval '30 days'
